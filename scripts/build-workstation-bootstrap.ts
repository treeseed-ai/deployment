...
const required = ['agent-codex-auth', 'api-postgres-password', 'api-database-url', 'api-session-secret', 'api-treedx-delegation-private-key', 'treedx-credential-broker-assertion'];
...
const credentials = {
	...
	'treedx-credential-broker-assertion': randomBytes(48).toString('base64url'),
};
