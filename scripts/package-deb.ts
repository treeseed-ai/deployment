...
const packages: Record<string, Definition> = {
	...
	'treeseed-lab': { ...component('lab', '0.1.0~rc22-1'), depends: 'treeseed-manager, treeseed-edge', description: 'Optional TreeSeed development mail and read-only diagnostics services' },
};
