...
const packages: Record<string, Definition> = {
	...
	'treeseed-manager': { architecture: 'amd64', depends: `treeseed-host-runtime (= ${deploymentVersion}), util-linux`, description: 'TreeSeed host manager, reconciler, mTLS API, and fixed root supervisor', postinst: 'debian/manager/postinst', payload: managerPayload },
	...
	'treeseed-component-api': component('api', '0.8.0~rc10'), 'treeseed-component-agent': component('agent', '0.13.0~rc13'),
	...
	'treeseed-lab': { ...component('lab', '0.1.0~rc14-1'), depends: 'treeseed-manager, treeseed-edge', description: 'Optional TreeSeed development mail and read-only diagnostics services' },
};
