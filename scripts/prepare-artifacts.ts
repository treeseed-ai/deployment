...
function lab(): ComponentRelease {
	...
	const runtime = { schemaVersion: 'treeseed.package-runtime/v1' as const, componentId: 'lab', version: '0.1.0~rc15-1', compose: { projectName: 'treeseed-lab', files: ['compose.yml'] }, services: [
...
const developmentComponents = [['agent', '0.13.0~rc13'], ['api', '0.8.0~rc11'], ['treedx', '0.3.0~rc5']].map(([id, release]) => {
...
const development = sealCatalog({ schemaVersion: 'treeseed.release-catalog/v1', release: '0.1.0~rc15', generation: 1_000_016, track: 'development', compatibilityId: stable.compatibilityId, stableBase: { release: stable.release, catalogDigest: stable.catalogDigest }, components: developmentComponents, createdAt: '2026-08-24T06:00:00.000Z' });
