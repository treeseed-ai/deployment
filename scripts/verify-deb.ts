...
const expected = aptSuite === 'stable' ? [...core, 'treeseed-component-agent'] : [...core, 'treeseed-component-api', 'treeseed-component-agent', 'treeseed-component-treedx', 'treeseed-component-ai', 'treeseed-lab'];
...
try {
	const proofPackages = aptSuite === 'stable' ? ['treeseed-host-runtime', 'treeseed-sdk', 'treeseed-cli', 'treeseed-release-catalog', 'treeseed-component-agent'] : ['treeseed-host-runtime', 'treeseed-sdk', 'treeseed-cli', 'treeseed-release-catalog', 'treeseed-component-agent', 'treeseed-component-api', 'treeseed-component-treedx', 'treeseed-lab'];
	...
	if (aptSuite === 'stable') {
		...
		for (const [id, release] of [['agent', '0.13.0~rc13'], ['api', '0.8.0~rc11'], ['treedx', '0.3.0~rc6'], ['lab', '0.1.0~rc20-1']] as const) {
