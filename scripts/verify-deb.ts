...
if (agentVersions.join(',') !== '0.12.58,0.13.0~rc13' || apiVersion !== '0.8.0~rc10' || treeDxVersion !== '0.3.0~rc5') throw new Error('Component Debian versions do not match their exact release contracts.');
