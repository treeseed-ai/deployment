...
${[owner, migration].map(role => `ALTER DEFAULT PRIVILEGES FOR ROLE ${role} IN SCHEMA public REVOKE ALL ON TABLES FROM PUBLIC, ${runtime};
ALTER DEFAULT PRIVILEGES FOR ROLE ${role} IN SCHEMA public REVOKE ALL ON SEQUENCES FROM PUBLIC, ${runtime};
ALTER DEFAULT PRIVILEGES FOR ROLE ${role} IN SCHEMA public GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO ${runtime};
