...
function fixture() {
  ...
  const authorization: SourceWorkspaceAuthorization = { schemaVersion: 'treeseed.source-workspace-authorization/v1', id: 'grant',
    ...
    mode: 'work', acquisition: 'upstream-authorized', publication: 'assignment-branch', publicationRef: 'treeseed/assignments/assignment/1', credentialBindingId: 'binding', issuedAt: now.toISOString(), expiresAt: new Date(+now + 60_000).toISOString() };
