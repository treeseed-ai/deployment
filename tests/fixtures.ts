...
export function host(): HostConfiguration {
	return hostConfigurationSchema.parse({
		...
		host: { id: 'test-host', role: 'development', architecture: 'amd64' }, runtime: { management: 'managed' },
		...
		network: { manager: { binding: '0.0.0.0:4790', aliases: ['manager.treeseed.localhost'], sans: ['manager.treeseed.localhost'], trustedLanCidrs: [] } }, secrets: {},
	});
}
